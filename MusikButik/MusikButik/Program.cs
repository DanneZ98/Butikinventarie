    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            void AlbumSongs()
            {
                ...
                {
                    Console.WriteLine(albums[i].name);
            ...
            //songs[0][albums[0].numberOfSongs] = new Songs("Concrete", "3min");
            //Console.WriteLine(songs[0][albums[0].numberOfSongs].songName);
            /*
            songs[1][albums[1].numberOfSongs] = new Songs("TIM", "Avicii", 0f, 2019, "38min", 100, 12);
            songs[2][albums[2].numberOfSongs] = new Songs("Dreamers", "JUNG", 0f, 2020, "33min", 100, 10);
            songs[3][albums[3].numberOfSongs] = new Songs("Doom Days", "Bastille", 0f, 2019, "40min", 100, 11);
            songs[4][albums[4].numberOfSongs] = new Songs("Väntar på en ängel", "Oskar Linnros", 0f, 2017, "39min", 100, 12);
            songs[5][albums[5].numberOfSongs] = new Songs("Är", "Snook", 0f, 2006, "41min", 100, 12);
            songs[6][albums[6].numberOfSongs] = new Songs("÷(Deluxe)", "Ed Sheeran", 0f, 2019, "59min", 100, 16);
            songs[7][albums[7].numberOfSongs] = new Songs("The Butterfly Effect", "Vargas & Lagola", 0f, 2019, "31min", 100, 11);
            songs[8][albums[8].numberOfSongs] = new Songs("CALM", "5 Seconds of Summer", 0f, 2019, "43min", 100, 13);
            songs[9][albums[9].numberOfSongs] = new Songs("Night & Day (Day Edition - Extra Tracks", "The Vamps", 0f, 2019, "41min", 100, 12);
            songs[10][albums[10].numberOfSongs] = new Songs("IRL", "HUMAN", 0f, 2019, "38min", 100, 11);
            songs[11][albums[11].numberOfSongs] = new Songs("Prequelle", "Ghost", 0f, 2019, "41min", 100, 10);
            songs[12][albums[12].numberOfSongs] = new Songs("RAMMSTEIN", "Rammstein", 0f, 2019, "46min", 100, 11);
            songs[13][albums[13].numberOfSongs] = new Songs("Gone Now", "Bleachers", 0f, 2019, "40min", 100, 12);
            songs[14][albums[14].numberOfSongs] = new Songs("Evolve", "Imgine Dragons", 0f, 2019, "43min", 100, 12);
            songs[15][albums[15].numberOfSongs] = new Songs("Morgna Sulele", "Morgna Sulele", 0f, 2019, "23min", 100, 7);
            songs[16][albums[16].numberOfSongs] = new Songs("What If Nothing", "WALK THE MOON", 0f, 2019, "55min", 100, 13);
            songs[17][albums[17].numberOfSongs] = new Songs("COWBOY BEBOP Tank! The! best!", "SEATBELTS", 0f, 2019, "50min", 100, 12);
            songs[18][albums[18].numberOfSongs] = new Songs("You Are OK", "The Maine", 0f, 2019, "44min", 100, 10);
            songs[19][albums[19].numberOfSongs] = new Songs("Pray For The Wicked", "Panic! At The Disco", 0f, 2019, "34min", 100, 11);
            songs[20][albums[20].numberOfSongs] = new Songs("AM", "Arctic Monkeys", 0f, 2019, "41min", 100, 12);
            songs[21][albums[21].numberOfSongs] = new Songs("Seal The Deal & Let's Boogie (Deluxe)", "Volbeat", 0f, 2019, "1h 6min", 100, 17);
            songs[22][albums[22].numberOfSongs] = new Songs("Affirmation", "Savage Garden", 0f, 2019, "53min", 100, 12);
            songs[23][albums[23].numberOfSongs] = new Songs("OMG What's Happening", "Ava Max", 0f, 2019, "21min", 100, 7);
            songs[24][albums[24].numberOfSongs] = new Songs("Svart, vitt och allt därimellan", "Daniel Adams-Ray", 0f, 2019, "38min", 100, 10);
            */
            /*
            #region Songs
            songs[0][albums[0].numberOfSongs] = new Songs("I disagree", "Poppy", 0f, 2020, "45min", 100, 14);
            songs[1][albums[1].numberOfSongs] = new Songs("TIM", "Avicii", 0f, 2019, "38min", 100, 12);
            songs[2][albums[2].numberOfSongs] = new Songs("Dreamers", "JUNG", 0f, 2020, "33min", 100, 10);
            songs[3][albums[3].numberOfSongs] = new Songs("Doom Days", "Bastille", 0f, 2019, "40min", 100, 11);
            songs[4][albums[4].numberOfSongs] = new Songs("Väntar på en ängel", "Oskar Linnros", 0f, 2017, "39min", 100, 12);
